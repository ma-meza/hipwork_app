...
import GroupSignalsScreen from "./GroupSignalsScreen";
    ...
    <SafeAreaView style={styles.container}>
        <View style={styles.topBar}>
            ...
            <View>
                ...
                <Text style={[globalStyle.regularText, {color:"#a1a1a1"}]}>71 members</Text>
            </View>
        </View>
        ...
        <TabNav.Navigator upperCaseLabel={false} tabBarOptions={{
                ...
                <TabNav.Screen name="Signals" component={GroupSignalsScreen}>
